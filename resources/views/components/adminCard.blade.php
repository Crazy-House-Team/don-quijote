<div class="border-2 m-4  border-gray-300 dark:border-gray-700 ">
    <div id="accordion-flush" data-accordion="collapse" data-active-classes=" shadow bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes=" text-gray-500 dark:text-gray-400">
        <h2 id="accordion-flush-heading-{{ $event->id }}">
            <button type="button" class="flex items-center justify-between w-full p-2.5 rounded text-left  bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-accordion-target="#accordion-flush-body-{{ $event->id }}" aria-expanded="true" aria-controls="accordion-flush-body-{{ $event->id }}">
